...
import '../index.css';  // You can leave global styles here if needed
...
function LoginRegister() {
    ...
    const SwitchContent = (type) => {
        ...
        if (type === 'register') {
            content.classList.add(styles.active);  // Updated for CSS modules
        } else {
            content.classList.remove(styles.active);  // Updated for CSS modules
        }
    };
    ...
    return (
        <div className={`${styles.content} justify-content-center align-items-center d-flex shadow-lg`} id='content'>
